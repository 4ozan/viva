        ...
        <div className="relative z-10 py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl shadow-lg transition-all duration-300 hover:shadow-xl hover:translate-y-[-5px] border border-white/20 relative overflow-hidden">
            ...
            <div className="mt-24 text-center">
              <a href="/contact" className="px-8 py-3 bg-black/40 backdrop-blur-sm text-white font-medium rounded-lg hover:bg-black/60 transition-all duration-300 transform hover:-translate-y-1 inline-flex items-center border border-white/20">
                Get Started Today
